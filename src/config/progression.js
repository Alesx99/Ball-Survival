export const PROGRESSION_CONFIG = {
    upgradeTree: {
        ...
        'aegis': { id: 'aegis', name: 'Mantello Divino', desc: 'Estende la finestra di invulnerabilità ai danni.', maxLevel: 5, type: 'passive', requiresMaxedPassives: true },
        'skull': { id: 'skull', name: 'Teschio Maledetto', desc: 'Aumenta exp, ma i nemici sono più forti e numerosi (+10% Curse).', maxLevel: 5, type: 'passive', requiresMaxedPassives: true },
        'torrona': { id: 'torrona', name: 'Scatola di Torrona', desc: 'Aumenta stats generali. Attenzione: al Liv 5 aggiunge +100% Curse.', maxLevel: 5, type: 'passive', requiresMaxedPassives: true },
        'magicMissile': { id: 'magicMissile', name: 'Proiettile Magico', desc: "L'attacco base, non potenziabile.", type: 'active' },
        'cyclone': { id: 'cyclone', name: 'Ciclone Vuoto', desc: 'Vortice statico che attrae debolmente i nemici prima di esplodere.', maxLevel: 4, type: 'active', minPlayerLevel: 62 },
        'armageddon': { id: 'armageddon', name: 'Armageddon', desc: 'Danno planetario enorme a schermo intero ogni minuto.', maxLevel: 1, type: 'active', minPlayerLevel: 70 },
        'cloaking': { id: 'cloaking', name: 'Velo D\'Ombra', desc: 'Diventi intangibile temporaneamente.', maxLevel: 4, type: 'active', minPlayerLevel: 66 },
        ...
        'singularity': { id: 'singularity', name: 'Singolarità', desc: 'Lancia un proiettile gravitazionale che attrae i nemici.', maxLevel: 4, type: 'active', minPlayerLevel: 50, rarity: 'cosmic' },
        'stellarAura': { id: 'stellarAura', name: 'Aura Stellare', desc: 'Crea un campo di stelle rotanti che danneggiano i nemici vicini.', maxLevel: 4, type: 'active', minPlayerLevel: 54, rarity: 'cosmic' },
        'pulsarRay': { id: 'pulsarRay', name: 'Raggio Pulsar', desc: 'Spara un raggio di energia pura altamente perforante.', maxLevel: 4, type: 'active', minPlayerLevel: 58, rarity: 'cosmic' },
        ...
        'heal': { id: 'heal', name: 'Impulso Curativo', desc: 'Rigenera salute.', details: "+10 Salute Curata, -1s Ricarica", maxLevel: 5, minPlayerLevel: 10 },
        ...
        'shield': { id: 'shield', name: 'Scudo Magico', desc: 'Assorbe 1 colpo nemico quando attivo.', details: "+0.3s Finestra, -0.8s Ricarica", maxLevel: 5, minPlayerLevel: 10 },
